        ...
        <div className="flex-1 bg-[#0F172A] text-white p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col h-full justify-between">
            <div>
              ...
              <p className="text-slate-200 font-medium max-w-xl text-base md:text-lg">Full-scale governance oversight of the Sahaayak global community infrastructure.</p>
            </div>
