        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-slate-400 max-w-3xl mx-auto font-medium leading-relaxed mb-10">
              During a crisis, the bottleneck isn't a lack of compassion—it's a lack of coordination. Sahaayak is the digital infrastructure for a more resilient India.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <div className="relative z-10">
                <h2 className="text-4xl font-bold font-mukta mb-8">The Sahaayak Solution</h2>
