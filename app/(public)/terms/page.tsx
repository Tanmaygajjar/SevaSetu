      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 bg-white p-12 rounded-3xl border border-[var(--border)] shadow-sm">
        ...
        <div className="prose prose-slate max-w-none space-y-6 text-[var(--ink-muted)]">
          ...
          <section className="space-y-4">
            ...
            <p>By accessing SevaSetu, you agree to be bound by these Terms of Service and all applicable laws and regulations in India.</p>
          </section>

          <section className="space-y-4">
            <h2 className="text-xl font-bold text-[var(--ink)]">2. Volunteer Conduct</h2>
            <p>Volunteers are expected to act with integrity and respect. SevaSetu is a platform for social impact and should not be used for commercial solicitation or harassment.</p>
          </section>
